...
class Grid3D:
    ...
    def __contains__(self,pt:Point3D) -> bool:
        ...
        return (0 <= pt.x-self._offset.x < self.width
                and 0 <= pt.y-self._offset.y < self.height
                and 0 <= pt.z-self._offset.z < self.depth)
        ...
        for z in range(self.depth):
            ...
            for y in range(self._offset.y,self._offset.y+steps):
                ...
                for x in range(self.width):
                    row.append(Location3D(self._offset.x+x,y,self._offset.z+z,
        ...
        for z in range(self.depth):
            ...
            for y in range(self.height):
                for x in range(self._offset.x,self._offset.x+steps):
                    self.grid[z].grid[y] = [Location3D(x,self._offset.y+y,self._offset.z+z,
                                                       Location3D.OPEN,fill_char)
                                            ] + self.grid[z].grid[y]
    ...
    def expand_in(self,steps:int,fill_char:str='.') -> None:
        ...
        for z in range(self._offset.z,self._offset.z+steps):
            ...
            for y in range(self.height):
                new_row = []
                for x in range(self.width):
                    new_row.append(Location3D(self._offset.x+x,self._offset.y+y,z,
                                              Location3D.OPEN,fill_char))
