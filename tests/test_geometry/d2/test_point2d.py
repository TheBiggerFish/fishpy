...
class TestPoint2dStaticMethods(unittest.TestCase):
    ...
    def test_random(self):
        random_point = Point2D.random(
            lower_bound=self.p1, upper_bound=Point2D(5, 5))
...
class TestPoint2dMethods(unittest.TestCase):
    ...
    def test_in_bounds(self):
        self.assertTrue(self.p1.in_bounds(
            lower_bound=Point2D(0, 0), upper_bound=Point2D(5, 5)))
        self.assertTrue(self.p2.in_bounds(
            lower_bound=Point2D(-1, -5), upper_bound=Point2D(10, 10)))
        self.assertFalse(self.p3.in_bounds(
            lower_bound=Point2D(-10, -10), upper_bound=Point2D(0, 0)))
        self.assertFalse(self.p4.in_bounds(
            lower_bound=Point2D(-5, -10), upper_bound=self.p4))
