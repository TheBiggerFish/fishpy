...
class TestLatticePointMethods(unittest.TestCase):
    ...
    def test_get_adjacent_points(self):
        ...
        self.assertSetEqual(set(self.p3.get_adjacent_points(diagonals=True)),
                            ...
                            LatticePoint(-1,2),LatticePoint(1,2),LatticePoint(-1,3),
        ...
        self.assertSetEqual(set(self.p2.get_adjacent_points(diagonals=True,
                                                            lower_bound=LatticePoint(0,-6),
                                                            upper_bound=LatticePoint(1,-5))),
                            {LatticePoint(0,-6)})

    def test_lattice_midpoint(self):
        self.assertEqual(self.p1.lattice_midpoint(self.p2),LatticePoint(1,-2))
        self.assertEqual(self.p2.lattice_midpoint(self.p3),LatticePoint(0,-2))
        self.assertEqual(self.p3.lattice_midpoint(self.p4),LatticePoint(-2,3))
        self.assertEqual(self.p4.lattice_midpoint(self.p1),LatticePoint(-1,3))
